...
@property (nonatomic) CGFloat maxYAxis;
...
//  Shift along the x Axis for the second data plot
@property (nonatomic) NSInteger horizontalShift;
...
// Set the chart with two data sets and two x position arrays and render them both to the view
